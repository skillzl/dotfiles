...
sh -c "$(wget -qO- https://raw.githubusercontent.com/skillzl/dotfiles/main/npm/packages.sh)"
...
curl https://raw.githubusercontent.com/skillzl/dotfiles/main/.zshrc > ~/.zshrc
